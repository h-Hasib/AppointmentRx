...
//    {
//        Task<TokenModel> GetTokens(UserCredential user);
...
//        public TokenService(UserManager<UserCredential> userManager, IConfiguration config, ICipherService cipherService)
//        {
...
//        public async Task<TokenModel> GetTokens(UserCredential user)
//        {
...
//        private async Task<TokenModel> GenerateAccessToken(UserCredential user)
//        {
...
//        private async Task<TokenModel> GenerateRefreshToken(UserCredential user)
//        {
//            const int length = 80;
